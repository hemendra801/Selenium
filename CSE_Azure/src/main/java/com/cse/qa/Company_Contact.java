...
public class Company_Contact {
	...
	WebElement Contact_Us = driver.findElement(By.xpath("//li[@id='menu-item-1216']//span[@class='menu-text'][contains(text(),'Company')]"));
	actions.moveToElement(Contact_Us).perform();
	System.out.println("Done Mouse hover on 'Company' from Menu");
	WebElement Contact= driver.findElement(By.xpath("//li[@id='menu-item-7236']//span[contains(text(),'Contact Us')]")); 
	Contact.click();	
	Thread.sleep(4000);
