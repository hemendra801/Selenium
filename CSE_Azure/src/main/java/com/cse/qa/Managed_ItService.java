...
public class Managed_ItService {
	WebDriver driver;
	@Test (priority=1)

	public void Managed_It() throws InterruptedException {
...
//Now Select 'Managed It Service' from sub menu which has got displayed on mouse hover of 'IT Service'
WebElement Managed_ItService = driver.findElement(By.xpath("//li[@id='menu-item-1276']//span[contains(text(),'Managed IT Services')]")); 
Managed_ItService.click();	
