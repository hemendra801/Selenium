...
public class Staff_Augmentation {
WebDriver driver;
@Test (priority=1)
...
WebElement Staff_Augmentation = driver.findElement(By.xpath("//li[@id='menu-item-7297']//span[contains(text(),'Staff Augmentation')]")); 
Staff_Augmentation.click();	
