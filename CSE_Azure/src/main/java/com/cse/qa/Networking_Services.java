...
public class Networking_Services {
	WebDriver driver;
	@Test (priority=1)

	public void Network_Service() throws InterruptedException {
...
WebElement Network_Service = driver.findElement(By.xpath("//li[@id='menu-item-1274']//span[contains(text(),'Networking Services')]")); 
Network_Service.click();	
