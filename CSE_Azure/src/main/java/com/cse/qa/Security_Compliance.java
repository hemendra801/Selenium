...
public class Security_Compliance {
	WebDriver driver;
	@Test (priority=1)
	...
	WebElement Security = driver.findElement(By.xpath("//li[@id='menu-item-6365']//span[@class='menu-text'][contains(text(),'Solutions')]"));
	actions.moveToElement(Security).perform();
	System.out.println("Done Mouse hover on 'Solutions' from Menu");
	WebElement Security_C= driver.findElement(By.xpath("//li[@id='menu-item-1265']//span[contains(text(),'Business Continuity')]")); 
	Security_C.click();	
	Thread.sleep(4000);
