...
public class Desaster_Recovery {
	WebDriver driver;
	@Test (priority=1)
	...
	WebElement Desaster = driver.findElement(By.xpath("//li[@id='menu-item-6365']//span[@class='menu-text'][contains(text(),'Solutions')]"));
	actions.moveToElement(Desaster).perform();
	System.out.println("Done Mouse hover on 'Solutions' from Menu");
	WebElement Security_C= driver.findElement(By.xpath("//li[@id='menu-item-1264']//span[contains(text(),'Disaster Recovery')]")); 
	Security_C.click();	
	Thread.sleep(4000);
