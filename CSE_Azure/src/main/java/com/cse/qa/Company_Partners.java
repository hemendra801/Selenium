...
public class Company_Partners {
	...
	WebElement Partner = driver.findElement(By.xpath("//li[@id='menu-item-1216']//span[@class='menu-text'][contains(text(),'Company')]"));
	actions.moveToElement(Partner).perform();
	System.out.println("Done Mouse hover on 'Company' from Menu");
	WebElement Partners= driver.findElement(By.xpath("//li[@id='menu-item-7709']//span[contains(text(),'Partners')]")); 
	Partners.click();	
	Thread.sleep(4000);
