...
public class Government {
	...
	public void Governments() throws InterruptedException {
	...
	WebElement Government = driver.findElement(By.xpath("//li[@id='menu-item-6366']//span[@class='menu-text'][contains(text(),'Industry')]"));
	actions.moveToElement(Government).perform();
	System.out.println("Done Mouse hover on 'Nonprofit_Edu' from Menu");
	WebElement Governments= driver.findElement(By.xpath("//li[@id='menu-item-1288']//span[contains(text(),'Government')]")); 
	Governments.click();	
	Thread.sleep(4000);
