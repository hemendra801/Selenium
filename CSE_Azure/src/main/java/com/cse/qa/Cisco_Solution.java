...
public class Cisco_Solution {
	...
	WebElement Cisco_Solution = driver.findElement(By.xpath("//li[@id='menu-item-6365']//span[@class='menu-text'][contains(text(),'Solutions')]"));
	actions.moveToElement(Cisco_Solution).perform();
	System.out.println("Done Mouse hover on 'Solutions' from Menu");
	WebElement cisco_S= driver.findElement(By.xpath("//li[@id='menu-item-7310']//span[contains(text(),'Cisco Solutions')]")); 
	cisco_S.click();	
	Thread.sleep(4000);
