...
public class Application_Development {
	WebDriver driver;
	@Test (priority=1)

	public void App_Development() throws InterruptedException {
...
//Now Select 'App_Development' from sub menu which has got displayed on mouse hover of 'IT Service'
WebElement App_Development = driver.findElement(By.xpath("//li[@id='menu-item-7296']//span[contains(text(),'Application Development')]")); 
App_Development.click();	
