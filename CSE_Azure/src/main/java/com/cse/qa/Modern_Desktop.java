...
public class Modern_Desktop {
	...
	WebElement Modern = driver.findElement(By.xpath("//li[@id='menu-item-6365']//span[@class='menu-text'][contains(text(),'Solutions')]"));
	actions.moveToElement(Modern).perform();
	System.out.println("Done Mouse hover on 'Solutions' from Menu");
	WebElement Modern_Desktop= driver.findElement(By.xpath("//li[@id='menu-item-1261']//span[contains(text(),'Modern Desktop')]")); 
	Modern_Desktop.click();	
