...
public class Company_About {
	...
	WebElement Company = driver.findElement(By.xpath("//li[@id='menu-item-1216']//span[@class='menu-text'][contains(text(),'Company')]"));
	actions.moveToElement(Company).perform();
	System.out.println("Done Mouse hover on 'Company' from Menu");
	WebElement Companys= driver.findElement(By.xpath("//li[@id='menu-item-7156']//span[contains(text(),'About us')]")); 
	Companys.click();	
	Thread.sleep(4000);
