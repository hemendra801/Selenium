...
public void ITService() throws InterruptedException {
...
Thread.sleep(4000);
driver.findElement(By.xpath("//li[@id='menu-item-6364']//span[@class='menu-text'][contains(text(),'IT Services')]")).click();
